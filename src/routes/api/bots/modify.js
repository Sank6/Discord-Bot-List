...
route.patch("/:id", auth, async (req, res) => {
    ...
    await Bots.updateOne({ botid: req.params.id }, {$set: { long, description, invite, prefix, support, website, github, owners: { primary: bot.owners.primary, additional: check.users } } })
